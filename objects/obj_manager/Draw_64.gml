...
if (global.spawn_timer < 750 and global.spawn_timer > 650){
draw_set_font(font_info);
draw_set_color(c_red);
draw_text(180,400,"First   player   to   hold   the   ball \n          for   sixty   seconds   wins  !");
}
if (global.spawn_timer < 649 and global.spawn_timer > 550){
draw_set_font(font_info);
draw_set_color(c_yellow);
draw_text(180,400,"First   player   to   hold   the   ball \n          for   sixty   seconds   wins  !");
}
